...
<div style="background-color:black;overflow-x: auto; padding:10px;border-radius:10px;margin:10px;">
<p><h3><bold>Hepatitis B Symptoms</bold></h3>
Short-term (acute) hepatitis B infection doesn’t always cause symptoms. For instance, it’s uncommon for children younger than 5 to have symptoms if they’re infected.</p>
If you do have symptoms, they may include:
<li>Jaundice (Your skin or the whites of the eyes turn yellow, and your pee turns brown or orange.)</li>
<li>Light-colored poop</li>
<li>Fever</li>
<li>Fatigue that persists for weeks or months</li>
<li>Stomach trouble like loss of appetite, nausea, and vomiting</li>
<li>Belly pain</li>
<li>Joint pain</li>
...
<br>
<h3><bold>Hepatitis B Causes and Risk Factors</bold></h3>
It’s caused by the hepatitis B virus, and it can spread from person to person in certain ways. You can spread the hepatitis B virus even if you don’t feel sick.</p>
The most common ways to get hepatitis B include:
<li>Sex</li>
<li>Sharing needles</li>
<li>Accidental needle sticks</li>
<li>Mother to child(Pregnancy)</li></p>
...
<li><a href="https://www.linkedin.com/in/gift-ojabu/">LinkedIn</a></li>
</br>
<li><a href="https://youtu.be/0jrHRv2pJXQ">Video Statistics on Hepatitis B</a></li>    
</div>
...
#Python Function
def main():
    """Hepatitis Mortality Prediction Application""" #Docstring-Explaning what we want to do in this section
